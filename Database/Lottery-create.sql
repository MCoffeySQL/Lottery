CREATE DATABASE [Lottery]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Lottery01', FILENAME = N'D:\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\DATA\Lottery01.mdf' , SIZE = 131072KB , FILEGROWTH = 65536KB ),
( NAME = N'Lottery02', FILENAME = N'D:\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\DATA\Lottery02.ndf' , SIZE = 131072KB , FILEGROWTH = 65536KB ),
( NAME = N'Lottery03', FILENAME = N'D:\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\DATA\Lottery03.ndf' , SIZE = 131072KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Lottery_log', FILENAME = N'D:\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\Log\Lottery_log.ldf' , SIZE = 65536KB , FILEGROWTH = 65536KB )
 WITH LEDGER = OFF
GO
ALTER DATABASE [Lottery] SET COMPATIBILITY_LEVEL = 160
GO
...
USE [Lottery]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [Lottery] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
